	...
	<div class="row justify-content-center">
		<div class="col-lg-5">
			...
			<div class="d-flex justify-content-between pt-4 small">
				<span>{{ request()->session()->get('email')}}</span>
				{{-- <span class="text-lighter text-decoration-none">Logging in as: <span class="font-weight-bold text-muted">{{Auth::user()->username}}</span></span>
				<span>
